...
export interface BentoSliceDefaultPrimaryBentoCardItem {
  ...
  /**
   * Description field in *Bento → Default → Primary → Bento Card*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: bento.default.primary.bento_card[].description
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  description: prismic.RichTextField;
...
export interface IntegrationsSliceDefaultPrimaryIconsItem {
  /**
   * Icons field in *Integrations → Default → Primary → Icons*
   *
   * - **Field Type**: Select
   * - **Placeholder**: *None*
...
export interface ShowcaseSliceDefaultPrimary {
  ...
  /**
   * Subheadng field in *Showcase → Default → Primary*
   *
   * - **Field Type**: Title
   * - **Placeholder**: *None*
   * - **API ID Path**: showcase.default.primary.subheadng
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  subheadng: prismic.TitleField;
...
export interface ShowcaseSliceReversePrimary {
  ...
  /**
   * Subheadng field in *Showcase → Reverse → Primary*
   *
   * - **Field Type**: Title
   * - **Placeholder**: *None*
   * - **API ID Path**: showcase.reverse.primary.subheadng
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  subheadng: prismic.TitleField;

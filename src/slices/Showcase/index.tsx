...
const Showcase = ({ slice }: ShowcaseProps): JSX.Element => {
  return (
    ...
    >
      ...
      />
      <div className="mt-16 grid items-center gap-8 rounded-xl border-blue-50/20 bg-gradient-to-b from-slate-50/15 to-slate-50/5 px-8 py-8 backdrop-blur-sm lg:grid-cols-3 lg:gap-0 lg:py-12">
        <div className="">
          ...
          <div className="mt-6 text-2xl font-normal">
            <PrismicRichText field={slice.primary.subheadng} />
          </div>
